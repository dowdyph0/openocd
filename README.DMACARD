# HOWTO BUILD WITH CH347 SUPPORT (MAYBE YOU HAVE TO ADD EXTRA DEPENDENCIES TAKE A LOOK TO THE OTHER README FILES)
...
# TO FLASH OR INTERACT WITH DMA CARD INTERNAL SPI MEMORY YOU HAVE TO ENABLE USB-SPI BRIDGE
...
# TO DOWNLOAD CURRENT SPI FIRMWARE TO A FILE (firmware_dump.bin)
